import type { GlobalBoostyEmote } from '@shared/models/emotes'
...
export const boostyEmotes: GlobalBoostyEmote[] = boostyEmoteUrls.map(emote => ({
	type: 'emote',
	provider: 'boosty',
	id: emote.id,
	scope: 'global',
	name: emote.id,
	code: emote.id.toLowerCase(),
}))

export const boostyEmotesMap: EmoteMap<GlobalBoostyEmote> = new Map(boostyEmotes.map(emote => [emote.id, emote]))
